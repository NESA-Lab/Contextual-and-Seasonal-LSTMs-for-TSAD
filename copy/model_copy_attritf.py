...
from zlp.FCVAE.copy.AttriTrans import AnomalyTransformer
...
class MyAttriTF(LightningModule):
    """Frequency-enhenced CVAE"""

    def __init__(self, hparams):
        super(MyAttriTF, self).__init__()
    ...
    def test_step(self, data_batch, batch_idx):
        ...
        with torch.no_grad():
            recon_prob = self.forward(x, "test")
        output = OrderedDict(
            {
                "y": y.cpu(),
    ...
    def add_model_specific_args():
        ...
        parser.add_argument("--window", default = 48, type=int)
