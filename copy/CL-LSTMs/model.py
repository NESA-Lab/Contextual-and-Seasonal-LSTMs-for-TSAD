...
import data_augment
from get_f1_score import best_f1, delay_f1, best_f1_without_pointadjust, event_f1
from sklearn.metrics import roc_auc_score
...
class MyATF(LightningModule):
    ...
    def test_epoch_end(self, outputs):
        ...
        # delay_f1_score, delay_precison, delay_recall, delay_predict = event_f1(
        #     score, label
        # )
    ...
    def add_model_specific_args():
        ...
        parser.add_argument(
            "--data_name", default="0efb375b-b902-3661-ab23-9a0bb799f4e3.csv-v85", type=str
        )
        parser.add_argument("--data_dir", default="./data/AIOPS/", type=str)
        parser.add_argument("--window", default = 150, type=int)
        ...
        parser.add_argument("--cycle", default = 24, type=int)
