...
from AnomalyLSTM import AnomalyLSTM
...
class MyATF(LightningModule):
    ...
    def __build_model(self):
        self.atf = AnomalyLSTM(self.hp)

    def forward(self, x, mode, mask):
        x = x.view(-1, self.hp.window)
        return self.atf.forward(x, mode, mask)
    ...
    def test_step(self, data_batch, batch_idx):
        ...
        with torch.no_grad():
            recon_prob = self.forward(x,"test", z_all)
    ...
    def add_model_specific_args():
        ...
        parser.add_argument("--input_dim", default=30,type=int)
        parser.add_argument("--batch_size", default=512, type=int)
        parser.add_argument("--learning_rate", default=0.0005, type=float)
        parser.add_argument("--condition_dim", default=16, type=int)
        ...
        parser.add_argument("--point_ano_rate", default=1, type=float)
